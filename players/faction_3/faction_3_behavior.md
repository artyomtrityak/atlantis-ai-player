# Faction 3 behavior rules

This is Faction 3 behavior rules explaining playstyle of the Faction 3.
...
Always load `strategy.md` file to understand high-level strategy.
